...
output "effective_backup_schedule" {
  ...
  value       = module.baseline.effective_backup_schedule
}
...
output "effective_delete_backups_after_days" {
  ...
  value       = module.baseline.effective_delete_backups_after_days
}
