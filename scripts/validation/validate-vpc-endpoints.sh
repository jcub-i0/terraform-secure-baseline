...
EXPECTED_INTERFACE_ENDPOINT_SERVICES="${EXPECTED_INTERFACE_ENDPOINT_SERVICES:-sts sqs logs ssm ssmmessages secretsmanager kms config sns ec2 events securityhub lambda guardduty-data}"
